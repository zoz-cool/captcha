...
from preprocess.captcha_generator import generator
...
class CaptchaDataset(Dataset):
    def __init__(
        ...
        with open(vocabulary_path, "r", encoding="utf-8") as fin:
    ...
    def __getitem__(self, idx):
        # 加载label
        if self.auto_gen:
            img, label_map = generator.gen_next()
    ...
    def __len__(self):
        return len(self.meta_info) if self.auto_gen else self.auto_num
